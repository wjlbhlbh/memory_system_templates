...
3. Continue any real unresolved `[WIP]`, `[AWAITING_QA]`, or `[REWORK]` state before starting new work. If state is `[IDLE]` or an empty template, proceed with the current task.
